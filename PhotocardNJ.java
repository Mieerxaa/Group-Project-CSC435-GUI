...
public class PhotocardNJ extends JFrame {
    ...
    public PhotocardNJ() {
        ...
        panel.setBackground(new Color(173, 196, 219)); // dusty blue
        ...
        // ===== ITEMS =====
        addItem(panel, "RM Photocard", 140, 140, 10.0, "image/nj-pc-1.jpg");
        addItem(panel, "JIN Photocard", 370, 140, 12.0, "image/nj-pc-2.jpg");
        addItem(panel, "JUNGKOOK Photocard", 600, 140, 15.0, "image/nj-pc-3.png");
