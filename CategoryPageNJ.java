...
public class CategoryPageNJ extends JFrame {

    public CategoryPageNJ() {
        ...
        // ===== TITLE =====
        JLabel title = new JLabel("NEW JEANS", SwingConstants.CENTER);
        ...
        // ===== IMAGE =====
        ImageIcon icon = new ImageIcon(Main.class.getResource("image/NEWJEANS-LOGO.jpg"));
