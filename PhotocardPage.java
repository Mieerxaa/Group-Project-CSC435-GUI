...
public class PhotocardPage extends JFrame {
    ...
    public PhotocardPage() {
        ...
        addItem(panel, "'The Daydream BELIEVERS'", 140, 140, 5.0, "image/bts-pc-1.jpg");
        addItem(panel, "BTS BUTTER WEVERSE", 370, 140, 6.0, "image/bts-pc-2.jpg");
        addItem(panel, "BTS Proof", 600, 140, 7.0, "image/bts-pc-3.png");
