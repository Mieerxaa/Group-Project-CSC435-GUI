...
public class AlbumBP extends JFrame {
    ...
    public AlbumBP() {
        ...
        addAlbum(panel, Main.class.getResource("image/bp-album-1.jpg"), "THE ALBUM (Version 1)", 140, 100, 20.0);
        addAlbum(panel, Main.class.getResource("image/bp-album-2.jpg"), "THE ALBUM (Version 2)", 370, 100, 25.0);
        addAlbum(panel, Main.class.getResource("image/bp-album-3.png"), "THE ALBUM (Version 3)", 600, 100, 30.0);
